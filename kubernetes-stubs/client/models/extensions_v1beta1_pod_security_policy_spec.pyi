...
class ExtensionsV1beta1PodSecurityPolicySpec:
    ...
    allowed_csi_drivers: typing.Optional[
        list[kubernetes.client.ExtensionsV1beta1AllowedCSIDriver]
    ]
    allowed_capabilities: typing.Optional[list[str]]
    allowed_flex_volumes: typing.Optional[
        list[kubernetes.client.ExtensionsV1beta1AllowedFlexVolume]
    ]
    allowed_host_paths: typing.Optional[
        list[kubernetes.client.ExtensionsV1beta1AllowedHostPath]
    ]
    ...
    run_as_group: typing.Optional[
        kubernetes.client.ExtensionsV1beta1RunAsGroupStrategyOptions
    ]
    run_as_user: kubernetes.client.ExtensionsV1beta1RunAsUserStrategyOptions
    runtime_class: typing.Optional[
        kubernetes.client.ExtensionsV1beta1RuntimeClassStrategyOptions
    ]
    ...
    def __init__(
        ...
        *,
        ...
        host_ports: typing.Optional[
            list[kubernetes.client.ExtensionsV1beta1HostPortRange]
        ] = ...,
        privileged: typing.Optional[bool] = ...,
        read_only_root_filesystem: typing.Optional[bool] = ...,
        required_drop_capabilities: typing.Optional[list[str]] = ...,
